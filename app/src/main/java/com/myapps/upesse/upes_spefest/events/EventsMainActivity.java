    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        mCardAdapter.addCardItem(new CardItem(R.drawable.c6, R.string.event_title_1, R.string.event_desc_1,
                ...
                */
        mCardAdapter.addCardItem(new CardItem(R.drawable.c11, R.string.event_title_11, R.string.event_desc_11,
                R.string.event11_contact1, R.string.event11_contact2, R.string.event11_contact3,
                R.string.event11_phoneno1, R.string.event11_phoneno2, R.string.event11_phoneno3));
        ...
        mCardAdapter.addCardItem(new CardItem(R.drawable.c12, R.string.event_title_12, R.string.event_desc_12,
                R.string.event12_contact1, R.string.event12_contact2, R.string.event12_contact3,
                R.string.event12_phoneno1, R.string.event12_phoneno2, R.string.event12_phoneno3));
